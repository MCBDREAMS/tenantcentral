  ...
  return ReactDOMServer.renderToStaticMarkup(
    <ReactMarkdown
      components={{
        ...
        h2: ({ children }) => <h2 style={{ fontSize: 18, fontWeight: 700, color: "#1e293b", marginTop: 20, marginBottom: 10 }}>{children}</h2>,
        h3: ({ children }) => <h3 style={{ fontSize: 15, fontWeight: 600, color: "#334155", marginTop: 14, marginBottom: 7 }}>{children}</h3>,
        h4: ({ children }) => <h4 style={{ fontSize: 13, fontWeight: 600, color: "#475569", marginTop: 11, marginBottom: 5 }}>{children}</h4>,
        p: ({ children }) => <p style={{ fontSize: 11, lineHeight: 1.7, color: "#334155", margin: "8px 0" }}>{children}</p>,
        li: ({ children }) => <li style={{ fontSize: 11, lineHeight: 1.7, color: "#334155", margin: "6px 0" }}>{children}</li>,
        ul: ({ children }) => <ul style={{ paddingLeft: 18, margin: "10px 0" }}>{children}</ul>,
        ol: ({ children }) => <ol style={{ paddingLeft: 18, margin: "10px 0" }}>{children}</ol>,
        ...
        table: ({ children }) => <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 10, margin: "12px 0", border: "1px solid #cbd5e1" }}>{children}</table>,
        thead: ({ children }) => <thead style={{ background: "#f1f5f9" }}>{children}</thead>,
        th: ({ children }) => <th style={{ textAlign: "left", padding: "6px 8px", fontWeight: 700, color: "#334155", border: "1px solid #cbd5e1" }}>{children}</th>,
        td: ({ children }) => <td style={{ padding: "6px 8px", color: "#475569", border: "1px solid #e2e8f0" }}>{children}</td>,
